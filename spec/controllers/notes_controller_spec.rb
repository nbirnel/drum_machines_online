  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved note as @note" do
        ...
        post :create, {:note => { "c3" => "invalid value" }}, valid_session
        assigns(:note).should be_a_new(Note)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested note" do
        ...
        Note.any_instance.should_receive(:update).with({ "c3" => "MyString" })
        put :update, {:id => note.to_param, :note => { "c3" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the note as @note" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Note.any_instance.stub(:save).and_return(false)
        put :update, {:id => note.to_param, :note => { "c3" => "invalid value" }}, valid_session
        assigns(:note).should eq(note)
      end
